...
CREATE TABLE `sylius_channel` (
  ...
  `tax_calculation_strategy` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `sylius_channel` VALUES (1,1,10,1,2866,1,'FASHION_WEB','Fashion Web Store','#0caf07',NULL,1,'localhost','2024-02-28 10:06:18','2024-03-27 03:33:48',NULL,'order_items_based','contact@example.com','+41 123 456 789',0,0,1,0);
